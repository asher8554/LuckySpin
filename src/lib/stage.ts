...
] satisfies Array<Omit<StageDef, "id">>;

function withStageId(id: MapId, index: number): StageDef {
  const stage = originalStages[index];
...
export const wheelOfFortuneStage = withStageId("wheel", 0);
export const bubblePopStage = withStageId("bubble", 1);
export const potOfGreedStage = withStageId("jar", 2);
export const yoruNiKakeruStage = withStageId("night", 3);

export const ROULETTE_STAGES: Record<MapId, StageDef> = {
  wheel: wheelOfFortuneStage,
  bubble: bubblePopStage,
  jar: potOfGreedStage,
  night: yoruNiKakeruStage,
};
